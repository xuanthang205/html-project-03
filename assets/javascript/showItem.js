...
const coursesControl = document.querySelector(".courses .control");
...
viewBtn.onclick = function () {
    ...
    coursesControl.style.display = "none"
...
let swiper1 = new Swiper(".testimonial-slide", {
    slidesPerView: 1,
    spaceBetween: 0,
    loop: true,
    autoplay: {
